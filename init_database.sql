...
insert into seller(seller_id, phone, password, shop_name)
values ('fbc575b6d9e24ba3945e11d530c05e3d', '18622222222', '1111', 'Web书库');
...
insert into book(book_id, seller_id, isbn, book_name, author, press, pub_date, shop_name, price, store_mount,
                 deal_mount, img)
values ('fd06daa273a54679af3eea0dfe223435', 'd81f04c7d81a495d90e3ef7286fb26c9', '978-7-04-046661-4', '单片机原理及应用',
        '张毅刚', '高等教育出版社', '2010-1-1', '小帅书屋', '36.5', '300', '120',
...
values ('cc427985edba4072bde9a9aa7b312f0e', 'fbc575b6d9e24ba3945e11d530c05e3d', '978-7-121-42489-2', '操作系统原理',
        '李国华', '人民出版社', '2019-12-6', 'Web书库', '461.4', '120', '15',
